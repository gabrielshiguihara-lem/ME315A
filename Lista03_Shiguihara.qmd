...
Resposta: Como estamos selecionando duas colunas ao mesmo tempo, quando usamos o `DISTINCT` a função apenas tira as linhas repetidas, mas como não há nenhuma linha em que existe `DNO` e `SALARY` iguais ao mesmo tempo, nenhuma linha é retirada.
...
Resposta: Sim, as cláusulas são logicamente equivalentes.
...
Resposta: Não, as cláusulas não são logicamente equivalentes.
